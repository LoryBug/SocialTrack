<?php
$tipo=$_POST["typeFilter"];
$km=$_POST["kmFilter"];
$regione=$_POST["regionFilter"];
?>
...
elseif ($tipo!="Tutto" && $km=="Tutto"&& $regione=="Tutto") {
    $lista = $dbh->getFilterType($tipo);
}
elseif ($tipo=="Tutto" && $km!="Tutto"&& $regione=="Tutto") {
    $lista = $dbh->getFilterkm($km);
    
}
elseif ($tipo=="Tutto" && $km=="Tutto"&& $regione!="Tutto") {
    $lista = $dbh->getFilterRegion($regione);
}
#due valori
elseif ($tipo!="Tutto" && $km!="Tutto"&& $regione=="Tutto") {
    $lista = $dbh->getFilterType_Km($tipo, $km);
} 
elseif ($tipo == "Tutto" && $km != "Tutto" && $regione != "Tutto") {
    $lista = $dbh->getFilterKm_Region($km, $regione);
}    
elseif ($tipo!="Tutto" && $km=="Tutto"&& $regione!="Tutto") {
    $lista = $dbh->getFilterType_Region($tipo, $regione);
}
elseif ($tipo!="Tutto" && $km!="Tutto"&& $regione!="Tutto") {
    $lista = $dbh->getFilteredtrack($tipo, $km,$regione);
}
?>

<!--print TRACK-->
<?php foreach ($lista as $Track): ?>
    <!--Post Card-->
